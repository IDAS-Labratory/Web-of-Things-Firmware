...
// html.h output destination path
const htmlOutputDest = "../firmware-back/src/default/html.h";

// Proxy target address: ESP8266 local IP
const proxyTarget = "192.168.1.90";

// Dev Server connection
const devServerHost = "0.0.0.0"; // Establish connection on Local IP
    ...
    plugins: [
        ...
        new EventHooksPlugin({
                ...
                if (argv.mode === "production") {
                    ...
                    const destination = htmlOutputDest;
